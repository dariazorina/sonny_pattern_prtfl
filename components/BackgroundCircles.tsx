...
function BackgroundCircles({ }: Props) {
    return (
        <motion.div
            ...
            {/* <div className='absolute border border-[#333333] rounded-full h-[200px] w-[200px] mt-52 animate-ping duration:2150' /> */}
            ...
            <div className='rounded-full border border-[#703333] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse' />
